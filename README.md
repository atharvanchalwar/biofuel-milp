...
All preprocessing scripts and cleaned data tables can be added under a structure such as:

```text
data/
  raw/        # original competition and external datasets
  processed/  # cleaned & merged data used in the model
  README.md   # notes on data sources and transformations
